...
The file is opened writable, because CDMConnector validates the CDM by writing a small probe table. Syrona only writes temporary and cohort tables; your OMOP data is not modified. If the file is shared, work on a copy.
